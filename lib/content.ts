...
export const ISSUE_RECEIPTS: Record<string, Receipt[]> = {
  ...
  guns: [
    ...
    { side: 'Both', who: 'Decades of gridlock', claim: 'Gun-rights groups spent $158M+ on lobbying since 2013; gun-control groups spent tens of millions more each cycle. The fight has run for decades — the money keeps flowing on both sides while the laws barely move.', source: 'OpenSecrets', url: 'https://www.opensecrets.org/news/issues/guns' },
  ],
  justice: [
    { side: 'Both', who: 'The 1994 Crime Bill', claim: 'Written by then-Sen. Biden, signed by President Clinton, and passed with Republican votes, the 1994 crime bill was — in the ACLU’s words — “the moment both parties fully embraced” the tough-on-crime policies that fed mass incarceration. A bipartisan bidding war, not one party’s sin.', source: 'ACLU', url: 'https://www.aclu.org/news/smart-justice/how-1994-crime-bill-fed-mass-incarceration-crisis' },
  ...
  rights: [
    ...
    { side: 'Democrat', who: 'Corporate "rainbow" hypocrisy', claim: 'Companies fly Pride flags every June — then quietly fund the politicians writing anti-LGBTQ laws. OpenSecrets documents Pride sponsors steering tens of thousands to the very legislators who advanced those bills; one tally found 25 companies gave $13.5M+ to anti-LGBTQ politicians. Allyship as marketing, not conviction.', source: 'OpenSecrets', url: 'https://www.opensecrets.org/news/2024/07/corporate-sponsors-of-pride-events-also-contribute-to-politicians-with-anti-lgbtq-leanings/' },
    { side: 'Both', who: 'Outrage as a product', claim: 'A topic affecting roughly 0.5% of Americans, almost never named in voter-priority surveys, gets amplified into a constant national fight — because the conflict itself drives donations, clicks, and turnout. The heat is the point; the people at the center become props in a money fight.', source: 'NBC News', url: 'https://www.nbcnews.com/politics/2022-election/gop-candidates-unleash-wave-ads-targeting-transgender-rights-rcna28945' },
  ],
}
